  ...
  return (
    <div className=" mx-auto overflow-x-hidden  h-[3820px]   md:h-[3440px]  bg-[#ffffff] flex flex-col max-w-[1440px] ">
          ...
          <div className="flex flex-col  md:w-1/2 xl:w-1/2">
                ...
                <div className="flex pr-[4px] items-center  justify-between ">

                <div className="flex gap-[6px] mt-[21px]  md:gap-[12px] md:mt-[20px]  xl:mt-[26px] ">
                  <div className=" w-[43px] h-[43px]  md:w-[61px] md:mr-[25px] xl:mr-[33px] md:h-[61px] xl:w-[71px]  ">
                  <Image
                    src={coin.icon}
                    alt={coin.fa_name}
                    width={60}
                ...
                <div className="flex flex-col mt-[21px] ml-[20px] gap-[8px] items-end ">
