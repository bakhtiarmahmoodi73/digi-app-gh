...
export default function CoinDetailsPage() {
  ...
  if (error || !coin)
    ...
    <p className="text-center mx-[20px] 2xl:mx-auto max-w-[1440px] text-red-500">اطلاعات رمز ارز یافت نشد</p>;
    </div>
  return (
    <div className=" mx-auto overflow-x-hidden  h-[3820px]   md:h-[3440px]  bg-[#ffffff] flex flex-col max-w-[1440px] ">
      <div className="bg-[#ffffff] w-[calc(100%-36px)] mx-[18px] h-[799px] mt-[40px]  rounded-[30px] shadow-[0_4px_103px_0_rgba(13,26,142,0.08)] flex flex-col md:flex  md:flex-row md:mt-[22px] md:mx-[50px] md:w-[calc(100%-100px)] md:h-[448px] xl:h-[481px] xl:mx-[150px] xl:w-[calc(100%-300px)] xl:mt-[60px]   ">
        <div className="flex flex-col  md:w-1/2 xl:w-1/2">
          <p className=" font-iran-sans-bold text-[#000000]  text-[14px] leading-[21.91px] mt-[32px] mr-[22px] md:mt-[45px] md:mr-[25px] xl:text-[16px] xl:mt-[29px] xl:mr-[33px]  ">
            قیمت لحظه ای :
          </p>
  ...
  <div className="flex gap-[6px] mt-[20px] md:gap-[12px] md:mt-[20px] xl:mt-[26px] items-center">
    ...
    <div className="flex flex-col gap-[8px] xl:gap-[12px] min-w-0 flex-1">
      <p className="font-iran-sans-bold text-[#000000] font-[700] text-[14px] leading-[21.91px] xl:text-[18px] truncate">
        {coin.fa_name}
      </p>
      <p className="font-iran-sans-regular text-[#696464] font-[400] text-[14px] leading-[21.91px] xl:text-[18px] truncate">
        {coin.currency_code}
      </p>
    </div>
  </div>
  <div className="flex flex-col mt-[20px] md:mt-[21px] xl:mt-[33px] gap-[8px] items-end">
    <p className="font-number-bold text-[14px] text-[#000000]  xl:text-[18px] whitespace-nowrap">
      {Number(coin.irt_price)
        .toFixed(0)
        .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}
      <span className="mr-[4px]">تومان</span>
    </p>
    <p className="font-number-regular text-[#696464] font-[400] text-[14px] xl:text-[18px] whitespace-nowrap">
      $
      {Number(coin.price)
        .toFixed(0)
        .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}
          ...
          <div className="flex flex-col mt-[24px] mr-[22px] ml-[25px] gap-[26px] md:gap-[32px] md:mt-[17px] xl:mr-[33px] xl:gap-[34px] xl:mt-[36px] ">
            <div className="flex justify-between">
              <p className=" font-iran-sans-regular text-[#000000]  text-[12px] leading-[18px] xl:text-[16px] ">
                تغییر قیمت امروز :
              </p>
              <p
                className={` font-iranSansnumber font-number-regular text-[12px] leading-[18px] xl:text-[16px]
                      ${
            ...
            <div className="flex justify-between">
              <p className=" font-iran-sans-regular text-[#000000] font-[400] text-[12px] leading-[18px] xl:text-[16px]">
                خرید بیت کوین:
              </p>
              <div className="flex justify-between gap-[4px]">
                ...
                <span className=" font-iran-sans-regular text-[#000000] font-[400] text-[12px] leading-[18px] xl:text-[16px]">
                  تومان
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <div className="flex justify-between gap-[4px]">
                ...
                <span className=" font-iran-sans-regular text-[#000000]  text-[12px] leading-[18px] xl:text-[16px]">
                  تومان
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-between">
              <p className=" font-number-regular text-[#000000]  text-[12px] leading-[18px] xl:text-[16px]">
                بالاترین قیمت 24 ساعته :
              </p>
              <div className="flex justify-between gap-[4px]">
                <p className=" font-number-regular text-[#147D03]  text-[12px] leading-[18px] xl:text-[16px]">
                  1.000.000.000
                </p>
                <span className=" font-iran-sans-regular text-[#000000]  text-[12px] leading-[18px] xl:text-[16px]">
                  تومان
            ...
            <div className="flex justify-between">
              ...
              <div className="flex justify-between gap-[4px]">
                <p className=" font-number-regular text-[#FF6868]  text-[12px] leading-[18px] xl:text-[16px]">
                  1.000.000.000
                </p>
                <span className=" font-iran-sans-regular text-[#000000] text-[12px] leading-[18px] xl:text-[16px]">
                  تومان
        ...
        <div className="mt-[26px]  mr-[22px] ml-[25px] md:mt-[41px] md:mr-0  md:w-1/2 xl:w-1/2 xl:mt-[29px] xl:mr-[12px] ">
          <p className=" font-iran-sans-bold text-[#000000]  text-[14px] leading-[21.91px] xl:text-[16px] ">
            ارسال می کنید:
          </p>
          ...
          <div className="mt-[12px]  h-[47px] rounded-[8px] bg-[#F8F9FA] flex items-center justify-between  xl:bg-[#F6F4F4] xl:rounded-[50px] xl:mt-[18px] ">
            <p className=" font-iran-sans-regular text-[#696464] font-[300] text-[12px] leading-[18.78px]  h-[19px] mr-[12px] ">
              مقدار را وارد کنید
            </p>
            <div className="flex items-center ml-[12px] gap-[38px]">
              <div className="flex items-center gap-[9.25px] ">
                ...
                <p className=" font-iran-sans-regular text-[#696464] font-[300] text-[12px] leading-[18.78px] ">
                  تومان
                </p>
              </div>
              <Image
          ...
          <div className="flex justify-between mt-[15px] xl:mt-[25px]">
            <p className=" font-iran-sans-bold text-[#000000]  text-[12px] leading-[18.78px] xl:text-[16px]">
              نرخ ارز یک
            </p>
            <p className=" font-number-bold text-[#000000]  text-[12px] leading-[18px] xl:text-[16px]">
              5.600 دلار
            </p>
          </div>
          ...
          <button className=" mt-[31px] w-full font-iran-sans-bold bg-[#1652F0] h-[47px]  rounded-[8px] text-[14px]  leading-[21.91px] text-[#FFFFFF]   xl:hidden">
            ثبت سفارش خرید
          </button>
      ...
      <div className="flex xl:mx-[150px] xl:w-[calc(100%-300px)] xl:gap-[30px] xl:mt-[161px] ">
        <div className="flex flex-col mx-[19px] w-[calc(100%-38px)] xl:mx-0 xl:w-1/2">
          <div className="flex mx-auto  mt-[53px] md:mt-[59px] xl:mx-0 xl:mt-0 ">
            <p className=" font-iran-sans-black text-[#000000]  text-[20px] leading-[31.3px]  md:text-[30px]">
              درباره
            </p>
            <span className=" font-iran-sans-black mr-2 text-[#0D1A8E] text-[20px]  leading-[31.3px]  md:text-[30px]">
              بیت کوین
            </span>
          </div>
          ...
          <p className=" text-[#000000] font-iran-sans-regular text-[12px] leading-[28px] w-full h-[252px] mt-[21px] md:text-[14px] md:mx-[30px] md:w-[calc(100%-50px)] xl:mx-0 xl:w-full xl:mt-[29px] xl:text-[16px] 2xl:leading-[32px]">
      ...
      <div className="flex flex-col  ">
        <p className=" font-iran-sans-black  text-[#000000] text-center  text-[20px] leading-[40px] mt-[58px] mx-[53px] md:mt-[137px] md:mx-auto md:text-[30px] xl:mt-[116px] xl:mx-[150px] xl:text-right ">
      ...
      <div className="flex flex-col mt-[39px] mx-[24px] gap-[39px] md:mt-[111px] md:gap-[36px] md:mx-[54px] xl:gap-[49px] xl:mx-[150px] xl:mt-[108px] ">
        <p className="  text-[#000000] font-iran-sans-black text-[20px] leading-[31.3px] mx-auto md:text-[30px] xl:mx-0  ">
          توضیحات بیشتر درباره بیت کوین
        </p>
        <p className=" font-iran-sans-regular text-[#000000]  text-[12px] leading-[28px] md:text-[14px] xl:text-[16px] ">
      ...
      <div className="mt-[120px] xl:mt-[108px] xl:mx-[150px] ">
        <p className="font-iran-sans-black text-[#000000]  text-[20px] leading-[31.3px] text-center md:text-[30px]  xl:text-right">
          سوالات متداول
        </p>
      </div>
      ...
      <div className="flex flex-col xl:mt-[58px] xl:mx-[150px] xl:gap-[38px] md:mt-[53px] md:mx-[50px] md:flex-row-reverse md:gap-[29px] gap-[24px] mt-[38px] mx-[20px] h-[454px]  rounded-[15px] bg-[#F8F9FA]  md:h-[294px] xl:h-[366px]  ">
        <div className="flex flex-col gap-[17px] md:gap-[26px] xl:gap-[43px] xl ">
          <p className="mt-[49px] mx-[47px] xl:text-[28px]  font-iran-sans-black text-[#000000]  text-[16px] leading-[25.04px] text-center  h-[25px]  md:leading-[31.3px] md:text-[20px] md:text-right ">
            علاقه مند به خرید بیت کوین هستید؟
          </p>
          <p className=" xl:text-[22px] mx-[44px] font-iran-sans-regular text-[#000000] font-[400] text-[12px] leading-[24px] text-center   md:leading-[32px] md:text-right md:text-[16px]">
            ما اینجا هستیم تا شما تجربه ای متفاوت از خرید و فروش بیت کوین داشته
            باشید.
          </p>
          <button className=" mx-[76px] h-[47px] font-iran-sans-bold  rounded-[50px] text-[16px] bg-[#1652F0] leading-[25.04px] text-center  text-[#ffffff] md:mx-0 md:mr-10 md:w-[182px] md:h-[47px]  ">
            اکنون شروع کنید
          </button>
        </div>
