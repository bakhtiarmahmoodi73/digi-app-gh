  ...
  return (
    <div className="mx-auto xl:max-w-[1240px] 2xl:max-w-[1440px]  overflow-x-hidden   py-10 flex flex-col items-center xl:items-center">
      <div className="xl:mr-10 2xl:mr-52">
        <h1 className="leading-[100%]  mx-auto text-right font-iranSans w-[301px] h-[31px] top-[114px] text-[20px] font-[900] text-[#000000] sm:w-[550px] sm:text-[25px]  sm:mb-4 md:text-[30px] md:left-[191px] md:top-[153px] md:h-[47px] md:w-[452px] lg:text-[40px] lg:w-[602px] lg:h-[63px] lg:top-[200px] lg:left-[419px] lg:font-[900] xl:text-center">
          لیست قیمت لحظه‌ای ارزهای دیجیتال‌
        </h1>

        <div className="flex sm:w-[700px] sm:mx-auto lg:w-[1020px] xl:w-[1200px]  gap-3 lg:gap-2 xl:gap-6  bg-[#ffffff]">
          <button className="flex mx-auto sm:w-[550px] sm:ml-16 md:ml-0  xl:w-[130px] items-center justify-between px-6 rounded-[8px] w-[335px] h-[47px] mt-6 font-iranSans text-[#EEF2F5] bg-[#1652F0] lg:w-[130px] lg:h-[47px] lg:top-[346px] lg:text-[14px] font-[400] md:w-[85px] md:h-[47px] md:top-[252px] md:text-[12px] sm:mt-0">
        ...
        <h2 className="w-[335px] mx-auto md:mr-0 lg:mr-2 xl:mr-0 xl:w-[500px] xl:ml-[900px] font-iranSans font-[900] text-black text-xl md:text-2xl lg:text-2xl  mb-4 xl:text-center">
          توضیحات کلی در مورد رمز ارزها
        </h2>

        <p className=" w-[335px] mx-auto sm:w-[530px] md:w-[700px] lg:w-[1000px] xl:w-[1185px] text-right font-iranSans font-[400] text-black text-sm md:text-base lg:text-lg leading-relaxed mb-8 ">
          ...
          <Image
            ...
            width={335}
          height={535}
          className="mx-auto mb-6 sm:w-[530px] md:w-[700px] lg:w-[1000px] xl:w-[750px]"
          />
        

        <p className="w-[335px] mx-auto sm:w-[530px] md:w-[700px] lg:w-[1000px] xl:w-[1185px] text-right font-iranSans font-[400] text-black text-sm md:text-base lg:text-lg leading-relaxed ">
          رمز ارز ها از پروتکل های رمزگرافیکی و یا کد های فوق العاده پیچیده برای
          رمز گذاری دیتاهای حساس و انتقال آن ها استفاده می کنند تا معاملات امنی
          را فراهم کنند. توسعه دهندگان رمز ارزها این پروتکل ها را بر پایه اصول
          پیچیده ریاضیات و مهندسی کامپیوتر بنا کرده اند که آن ها را غیرقابل نفوذ
